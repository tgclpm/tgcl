...
import { logger, updateRateLimits, isRateLimited } from '@sentry/utils';
import { REPLAY_EVENT_NAME, UNABLE_TO_SEND_REPLAY } from '../constants.js';
import { createReplayEnvelope } from './createReplayEnvelope.js';
import { prepareRecordingData } from './prepareRecordingData.js';
import { prepareReplayEvent } from './prepareReplayEvent.js';
...
export { RateLimitError, TransportStatusCodeError, sendReplayRequest };
