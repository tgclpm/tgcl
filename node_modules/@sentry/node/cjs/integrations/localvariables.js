...
class LocalVariables  {
  ...
  ) {;this._session = _session;LocalVariables.prototype.__init.call(this);LocalVariables.prototype.__init2.call(this);}
  ...
  /** Setup in a way that's easier to call from tests */
   _setup(
    ...
    if (this._session && _optionalChain([clientOptions, 'optionalAccess', _22 => _22._experiments, 'optionalAccess', _23 => _23.includeStackLocals])) {
   ...
   */
   async _handlePaused(
    ...
    const framePromises = callFrames.map(async ({ scopeChain, functionName, this: obj }) => {
      ...
      const vars = await _optionalChain([this, 'access', _27 => _27._session, 'optionalAccess', _28 => _28.getLocalVariables, 'call', _29 => _29(localScope.object.objectId)]);
   ...
   */
   async _addLocalVariables(event) {
    for (const exception of _optionalChain([event, 'optionalAccess', _30 => _30.exception, 'optionalAccess', _31 => _31.values]) || []) {
   ...
   */
   async _addLocalVariablesToException(exception) {
    const hash = hashFrames(_optionalChain([exception, 'optionalAccess', _32 => _32.stacktrace, 'optionalAccess', _33 => _33.frames]));
    ...
    const frameCount = _optionalChain([exception, 'access', _34 => _34.stacktrace, 'optionalAccess', _35 => _35.frames, 'optionalAccess', _36 => _36.length]) || 0;
    ...
    for (let i = 0; i < frameCount; i++) {
      ...
      if (!_optionalChain([exception, 'optionalAccess', _37 => _37.stacktrace, 'optionalAccess', _38 => _38.frames, 'optionalAccess', _39 => _39[frameIndex]]) || !cachedFrames[i]) {
        break;
      }
